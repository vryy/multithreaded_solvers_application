...
namespace Kratos
{
    ...
    void r8cmat_print_some ( int m, int n, double **a, int ilo, int jlo, int ihi, int jhi, std::string title );
    ...
    void r8col_sorted_tol_undex ( int m, int n, double a[], int unique_num, double tol, int undx[], int xdnu[] );
    ...
    void r8col_sorted_undex ( int m, int n, double a[], int unique_num, int undx[], int xdnu[] );
    ...
    void r8col_undex ( int x_dim, int x_num, double x_val[], int x_unique_num, int undx[], int xdnu[] );
    ...
    int r8poly2_ex2 ( double x1, double y1, double x2, double y2, double x3, double y3, double *x, double *y, double *a, double *b, double *c );
    void r8poly2_rroot ( double a, double b, double c, double *r1, double *r2 );
    void r8poly2_val ( double x1, double y1, double x2, double y2, double x3, double y3, double x, double *y, double *yp, double *ypp );
    ...
    void r8r8r8vec_index_insert_unique ( int maxn, int &n, double x[], double y[], double z[], int indx[], double xval, double yval, double zval, int &ival, int &ierror );
    void r8r8r8vec_index_search ( int n, double x[], double y[], double z[], int indx[], double xval, double yval, double zval, int &less, int &equal, int &more );
    void r8r8vec_index_insert_unique ( int maxn, int &n, double x[], double y[], int indx[], double xval, double yval, int &ival, int &ierror );
    void r8r8vec_index_search ( int n, double x[], double y[], int indx[], double xval, double yval, int &less, int &equal, int &more );
    ...
    void r8rmat_print_some ( int m, int n, double **a, int ilo, int jlo, int ihi, int jhi, std::string title );
    ...
    void r8vec_direct_product ( int factor_index, int factor_order, double factor_value[], int factor_num, int point_num, double x[] );
    ...
    void r8vec_mask_print ( int n, double a[], int mask_num, int mask[], std::string title );
    ...
    void r8vec2_print_some ( int n, double x1[], double x2[], int max_print, std::string title );
